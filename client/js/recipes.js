...
const recipes = {
    ...
    'old-fashioned': {
        ...
        ingredients: ['60 מ"ל בורבון', '2-3 טיפות ביטרס אנגוסטורה', 'קוביית סוכר', 'תפוז'],
        steps: [
    ...
    'mojito': {
        ...
        ingredients: ['50 מ"ל רום לבן', '30 מ"ל מיץ ליים', '20 מ"ל סירופ סוכר', 'נענע', 'סודה'],
        steps: [
    ...
    'manhattan': {
        ...
        ingredients: ['60 מ"ל ויסקי ריי', '30 מ"ל ורמוט מתוק', '2 טיפות ביטרס אנגוסטורה', 'דובדבן'],
        steps: [
    ...
    'margarita': {
        ...
        ingredients: ['50 מ"ל טקילה', '25 מ"ל קואנטרו', '25 מ"ל מיץ ליים', 'מלח'],
        steps: [
            'מלחו את שולי הכוס',
    ...
    'cosmopolitan': {
        ...
        ingredients: ['45 מ"ל וודקה', '25 מ"ל קואנטרו', '25 מ"ל מיץ חמוציות', '15 מ"ל מיץ ליים'],
        steps: [
            'מזגו את כל המרכיבים לשייקר עם קרח',
            'נערו היטב למשך 15 שניות',
            'מזגו לכוס מרטיני מקוררת',
    ...
    'negroni': {
        ...
        ingredients: ['30 מ"ל ג\'ין', '30 מ"ל ורמוט מתוק', '30 מ"ל קמפרי', 'תפוז'],
        steps: [
    ...
    'daiquiri': {
        ...
        ingredients: ['50 מ"ל רום לבן', '25 מ"ל מיץ ליים טרי', '20 מ"ל סירופ סוכר'],
        steps: [
            'מזגו את כל המרכיבים לשייקר עם קרח',
            'נערו היטב למשך 15 שניות',
            'מזגו לכוס קוקטייל מקוררת',
    ...
    'whiskey-sour': {
        title: 'וויסקי סאוור',
        image: '../assets/images/cocktails/whiskeysour.jpg',
        ingredients: ['50 מ"ל וויסקי בורבון', '25 מ"ל מיץ לימון טרי', '20 מ"ל סירופ סוכר', '(אופציונלי: חלבון ביצה)'],
        steps: [
